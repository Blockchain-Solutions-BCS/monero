...
ENTRYPOINT ["monerobsd", "--p2p-bind-ip=0.0.0.0", "--p2p-bind-port=18180", "--rpc-bind-ip=0.0.0.0", "--rpc-bind-port=18181", "--non-interactive", "--confirm-external-bind"]
